...
export const Demo = () => {
  return (
    <section className="mt-7 lg:mt-12" id="demonstracao">
      <div className="flex flex-col items-center text-3xl" id="">
        ...
        <div className="min-h-42 max-w-86 rounded-2xl border border-gray-700 p-4 shadow-2xl">
          <div className="mb-3 flex flex-col items-center justify-center">
            ...
            <p>
              ...
              Fotossíntese é o processo pelo qual as plantas transformam luz
              solar em energia para crescer. Elas utilizam água, gás carbônico e
              luz para produzir alimento e oxigênio.
            </p>
          </div>
        </div>
      </div>
