  ...
  return (
    <section id="planos" className="mt-7 lg:mt-12">
      ...
      <div className="mt-4 flex flex-col items-center justify-center gap-4 md:flex-row lg:mt-8">
        {cardItems.map((item) => (
          <div className="min-h-42 min-w-76 rounded-2xl border border-gray-700 p-4 shadow-2xl">
            ...
            <div className="mt-3 w-full  ">
              <Link
                className="from-primary-700 font-bold flex justify-center w-full hover:from-secondary-600 hover:to-primary-700 to-secondary-600 rounded-xl bg-linear-to-r px-4 py-2 text-center text-lg text-white transition-all duration-500 md:text-lg"
